...
| **Roblox Studio** | `roblox-specialist` | Luau, Rojo sync, MCP live bridge |
...
game-rojo/                          # Rojo project (syncs Luau scripts to Roblox Studio)
...
- **Pick your engine** — use the Godot, Unity, Unreal, or Roblox agent set (or none)
